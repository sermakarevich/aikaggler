# MCTS | OOF PredFE+PubNB Blending|LB[.425]

- **Author:** yukiZ
- **Votes:** 593
- **Ref:** hideyukizushi/mcts-oof-predfe-pubnb-blending-lb-425
- **URL:** https://www.kaggle.com/code/hideyukizushi/mcts-oof-predfe-pubnb-blending-lb-425
- **Last run:** 2024-11-17 11:24:08.620000
...
* forked original great work kernels
    * https://www.kaggle.com/code/andreasbis/mcts-oof-predictions-as-features

* **2024/10/17 upd**
    * HP update
* **2024/11/17 upd**
    * Change Split GKF -> SGKF
    * Blending public NB(LB.427)
        * https://www.kaggle.com/code/yunsuxiaozi/mcts-starter
```
※Additional information regarding this version 3(11/17).
In the past, it's based on a kernel that was briefly made public by blending mine and Yunsuxiaozi's public NB.
```
