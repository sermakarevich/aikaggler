# RSNA2025 32ch|5Fold Blending Weight|LB.69+

- **Author:** yukiZ
- **Votes:** 145
- **Ref:** hideyukizushi/rsna2025-32ch-5fold-blending-weight-lb-69
- **URL:** https://www.kaggle.com/code/hideyukizushi/rsna2025-32ch-5fold-blending-weight-lb-69
- **Last run:** 2025-10-03 18:00:33.260000
...
### **ℹ️INFO**
* First, here's the awesome inference pipeline and model weights shared.
    * [RSNA2025 32ch img infer LB 0.69 share](https://www.kaggle.com/code/yosukeyama/rsna2025-32ch-img-infer-lb-0-69-share)
 
### **ℹ️[LB.69+ 2025/10/04]MyUpdate**
* Since there seemed to be some variance in CV/LB between folds, we added weights to the fold inference results.
* Ideally, optimal weighting should be based on CV, but please note that this source uses LB scores as the basis.
```
    weights=[1.0,1.0,0.86,1.1,1.0]
...
# 》》》**Predict Use Model Weight Blend**
...
def load_model_fold(fold: int) -> nn.Module:
    ...
    print("[INFO]LoadModel>>>",model_path)
...
# 》》》**Submit Kaggle Inference Server**
