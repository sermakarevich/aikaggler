# Not this year's Raddar Notebook

- **Author:** Pizzaboi
- **Votes:** 125
- **Ref:** asimandia/not-this-year-s-raddar-notebook
- **URL:** https://www.kaggle.com/code/asimandia/not-this-year-s-raddar-notebook
- **Last run:** 2026-03-18 21:26:48.900000
...
```python
alpha = 0.9
X['Pred'] = X['Pred'].apply(lambda x: x * alpha + round(x) * (1 - alpha) if x > 0.9 or x < 0.1 else x)
manual_overrides =  {
