# Lux AI Season Starter Notebook

- **Author:** Zakir Khan
- **Votes:** 66
- **Ref:** zakirkhanaleemi/lux-ai-season-starter-notebook
- **URL:** https://www.kaggle.com/code/zakirkhanaleemi/lux-ai-season-starter-notebook
- **Last run:** 2024-12-09 21:25:37.143000
...
Join our Discord server at https://discord.gg/aWJt3UAcgn or at the minimum follow the kaggle forums at https://www.kaggle.com/c/lux-ai-season-3/discussion. Important announcements such as changes to rules, events, and opportunities from sponsors!
...
```python
evaluate_agents(Agent, Agent) # here we evaluate our dummy agent against itself
