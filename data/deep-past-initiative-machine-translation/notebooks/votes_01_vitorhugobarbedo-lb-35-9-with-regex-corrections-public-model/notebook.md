...
- **Author:** Vitor Hugo Barbedo
- **Votes:** 634
- **Ref:** vitorhugobarbedo/lb-35-9-with-regex-corrections-public-model
- **URL:** https://www.kaggle.com/code/vitorhugobarbedo/lb-35-9-with-regex-corrections-public-model
- **Last run:** 2026-03-16 14:00:43.650000
...
class EnsembleMBRConfig:
    ...
    model_b_path:   str = "/kaggle/input/datasets/vitorhugobarbedo/model-final-2026"
