# 0.69 ensemble 3 models + embeddings

- **Author:** Antonoof
- **Votes:** 520
- **Ref:** antonoof/0-69-ensemble-3-models-embeddings
- **URL:** https://www.kaggle.com/code/antonoof/0-69-ensemble-3-models-embeddings
- **Last run:** 2025-12-22 19:06:26.280000

---

### Thanks:
#### [Chika Komari](https://www.kaggle.com/code/gothamjocker/lb-0-66-dino-v2-backbone-mamba-multi-vit)

#### [samu2505](https://www.kaggle.com/code/samu2505/csiro-pca-pls-text-embeddings)
...
def main():
    ...
    weight1, weight2, weight3 = 0.45, 0.35, 0.2
