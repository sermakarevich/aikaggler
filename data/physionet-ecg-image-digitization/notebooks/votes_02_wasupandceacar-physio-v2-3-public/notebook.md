...
- **Votes:** 321
- **Ref:** wasupandceacar/physio-v2-3-public
- **URL:** https://www.kaggle.com/code/wasupandceacar/physio-v2-3-public
- **Last run:** 2025-12-09 12:28:12.617000

---

Previous verison: [https://www.kaggle.com/code/wasupandceacar/physio-v2-2-public](https://www.kaggle.com/code/wasupandceacar/physio-v2-2-public)
...
2. Coresponding changes with resolution change in stage2: network, preprocess, postprocess...
...
for n, sample_id in enumerate(tqdm(valid_id)):
    ...
    batch = resize(torch.from_numpy(np.ascontiguousarray(image.transpose(2, 0, 1))).unsqueeze(0)).float().to(CUDA0)
