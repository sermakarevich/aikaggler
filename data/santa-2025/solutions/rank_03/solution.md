# Third place solution: a customized sparrow algorithm

- **Author:** Gilles Vandewiele
- **Date:** 2026-01-31T12:45:51.823Z
- **Topic ID:** 671181
- **URL:** https://www.kaggle.com/competitions/santa-2025/discussion/671181
---

# Preface
First, I would like to extend a huge thank you to the kaggle team organizing this competition. This has been one of the most fun Santa competitions we ever participated in. Further, a huge congratulations to all participants and @jeroencottaar for the solo victory. Finally I'd like to thank all my fellow team mates without whom this achievement would not have been possible @zidmie, @khahuras, @delporterobbe and @olehugnivenko 
...
![](https://www.googleapis.com/download/storage/v1/b/kaggle-user-content/o/inbox%2F443651%2F41a76862d4a189ddb00685d193579cc9%2FSanta_Overview_Crop.png?generation=1769862536688703&alt=media)
...
![](https://www.googleapis.com/download/storage/v1/b/kaggle-user-content/o/inbox%2F443651%2F526f0e0d159e28cc9ccc075193cbedce%2Frectangle_combination_example.png?generation=1769862429740357&alt=media)

As a funny coincidence, if we plotted out the minimum and maximum dimensions of our generated rectangles, birds (sparrows?) seem to appear!

![](https://www.googleapis.com/download/storage/v1/b/kaggle-user-content/o/inbox%2F443651%2Fb3ecf731570ad753a90cb10287061e5c%2Fbirds.jpg?generation=1769862474346554&alt=media)

By applying purely this algorithm, **a score of roughly 70.0** can be achieved.

# Simulated annealing + compression
Early on, we translated one of the SA notebooks that was [made publicly available in the first days of the competition](https://www.kaggle.com/code/crodoc/87-38-hybrid-optimization-strategy) into C++ and added multi-threading to it. Oleh, who only merged with us in January 2026 was using [another public notebook SA algorithm](https://www.kaggle.com/code/blueshyy/adaptive-sa) translated to C++. 
...
## Allow to pass along an initial solution for sparrow to start from (warm start)
...
![](https://www.googleapis.com/download/storage/v1/b/kaggle-user-content/o/inbox%2F443651%2F4a90a2126e71d05141115a4dc45f5228%2Fformula1.png?generation=1769862877691056&alt=media)
...
![](https://www.googleapis.com/download/storage/v1/b/kaggle-user-content/o/inbox%2F443651%2F45085aeb974c97d7532195d720a1ee73%2Fformula2.png?generation=1769862900570170&alt=media)
...
![](https://www.googleapis.com/download/storage/v1/b/kaggle-user-content/o/inbox%2F443651%2Fcef0a85b59e733d3857bcf64bce023d8%2Fupsample.png?generation=1769863018387326&alt=media)
...
![](https://www.googleapis.com/download/storage/v1/b/kaggle-user-content/o/inbox%2F443651%2Fc77e839126f20308f9e6798aa529dc21%2Fslackbot.png?generation=1769863079539023&alt=media)
...
A graph with the score and side lengths per n can be found below:
![](https://www.googleapis.com/download/storage/v1/b/kaggle-user-content/o/inbox%2F443651%2F4c78032b683989ba84ed52375d35efa4%2FScore_per_n.png?generation=1769863139148246&alt=media)
...
![](https://www.googleapis.com/download/storage/v1/b/kaggle-user-content/o/inbox%2F443651%2Fd781c7cf79e90f8b361fff48d1fe7096%2Fangles.png?generation=1769863221136382&alt=media)
...
Enjoy this video of our final solutions: https://www.youtube.com/shorts/Ru8dcAfGb-E
![](https://www.youtube.com/shorts/Ru8dcAfGb-E)
