# Ensemble NFL Big Data Bowl 2026 V1

- **Author:** Pankaj Gupta
- **Votes:** 239
- **Ref:** pankajiitr/ensemble-nfl-big-data-bowl-2026-v1
- **URL:** https://www.kaggle.com/code/pankajiitr/ensemble-nfl-big-data-bowl-2026-v1
- **Last run:** 2025-11-14 04:52:06.047000
...
def predict(test: pl.DataFrame, test_input: pl.DataFrame) -> pd.DataFrame:
    ...
    pred_ensemble = (pred_gru[['x', 'y']].values + pred_gnn[['x', 'y']].values) / 2
