# Baseline: DINO+ALIKED+LightGLUE edit Params

- **Author:** Su Thanh Cong
- **Votes:** 114
- **Ref:** suthcong/baseline-dino-aliked-lightglue-edit-params
- **URL:** https://www.kaggle.com/code/suthcong/baseline-dino-aliked-lightglue-edit-params
- **Last run:** 2025-05-23 03:32:54.043000
...
for dataset, predictions in samples.items():
    ...
    try:
        ...
        mapper_options.max_num_models = 24
        mapper_options.max_model_overlap = 18  # default 20
