# MABe | LGB + XGB + CatBoost

- **Author:** MT.L
- **Votes:** 257
- **Ref:** kerta27/mabe-lgb-xgb-catboost
- **URL:** https://www.kaggle.com/code/kerta27/mabe-lgb-xgb-catboost
- **Last run:** 2025-10-31 02:03:15.033000
...
def submit_ensemble(body_parts_tracked_str, switch_tr, X_tr, label, meta, n_samples):
    ...
    models.append(make_pipeline(
        StratifiedSubsetClassifier(
            lightgbm.LGBMClassifier(
                n_estimators=400, learning_rate=0.07, min_child_samples=40,
    ...
    models.append(make_pipeline(
        StratifiedSubsetClassifier(
            lightgbm.LGBMClassifier(
                n_estimators=300, learning_rate=0.1, min_child_samples=20,
    ...
    for switch_te, data_te, meta_te, actions_te in generator:
        ...
        try:
            ...
            weights = [0.20, 0.15, 0.25, 0.22, 0.18]  # adjust based on model order
