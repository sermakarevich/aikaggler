# Gemma-2 9b 4-bit QLoRA - LB 0.63

- **Author:** Md Boktiar Mahbub Murad
- **Votes:** 452
- **Ref:** mbmmurad/gemma-2-9b-4-bit-qlora-lb-0-63
- **URL:** https://www.kaggle.com/code/mbmmurad/gemma-2-9b-4-bit-qlora-lb-0-63
- **Last run:** 2024-11-26 20:33:33.067000
...
def determine_winner(row):
    if row["winner_model_a"] > row["winner_model_b"]:
        return "model_a"
    elif row["winner_model_a"] < row["winner_model_b"]:
        return "model_b"
    else:
        return "model_a"  # In case of tie
