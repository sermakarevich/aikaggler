...
- **Author:** Egor Trushin
- **Votes:** 222
- **Ref:** egortrushin/gwi-improved-unet-pipepline-with-larger-dataset
- **URL:** https://www.kaggle.com/code/egortrushin/gwi-improved-unet-pipepline-with-larger-dataset
- **Last run:** 2025-04-25 16:01:56.547000

---

# [GWI] Improved UNet pipepline with larger dataset
- The aim is to improve the best score, that is currently publicly available, using Kaggle's computational resources.
- We are going to use UNet model as introduced in [5 depth U net with residual](https://www.kaggle.com/code/adhok93/5-depth-u-net-with-residual) Notebook.
- We are going to use part of Full OpenWFI dataset, which was introduced in [OpenFWI InversionNet Train with 670G Datasets](https://www.kaggle.com/code/seshurajup/openfwi-inversionnet-train-with-670g-datasets) Notebook.
